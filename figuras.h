...
class CFiguras
{
	...
	void prisma3(GLuint text, GLuint text2, float repeticiones);
	void skybox(float altura, float largo, float profundidad, GLuint text, float moveI, float moveF);	//Funcion creacion cielo
	void skybox2 (float altura, float largo, float profundidad, GLuint text);
	void torus(GLfloat radioM, GLfloat radiom, int meridianos, int paralelos);
	void prisma4(GLuint text, GLuint text2, float repeticionesX, float repeticionesY);
