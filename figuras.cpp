...
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint text,float moveI, float moveF)  //Funcion creacion cielo
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Front
			...
			glTexCoord2f(0.0f + moveI, 0.0f); glVertex3fv(vertice[0]);
			glTexCoord2f(0.0f + moveI, 1.0f); glVertex3fv(vertice[4]);
			glTexCoord2f(1.0f + moveF, 1.0f); glVertex3fv(vertice[7]);
			glTexCoord2f(1.0f + moveF, 0.0f); glVertex3fv(vertice[1]);
		glEnd();

		glBegin(GL_POLYGON);	//Right
			glNormal3f( -1.0f, 0.0f, 0.0f);
			glTexCoord2f(0.0f - moveI, 0.0f); glVertex3fv(vertice[0]);
			glTexCoord2f(1.0f - moveI, 0.0f); glVertex3fv(vertice[3]);
			glTexCoord2f(1.0f - moveF, 1.0f); glVertex3fv(vertice[5]);
			glTexCoord2f(0.0f - moveF, 1.0f); glVertex3fv(vertice[4]);
		glEnd();

		glBegin(GL_POLYGON);	//Back
			glNormal3f( 0.0f, 0.0f,1.0f);
			glTexCoord2f(0.0f + moveI, 1.0f); glVertex3fv(vertice[6]);
			glTexCoord2f(1.0f + moveI, 1.0f); glVertex3fv(vertice[5]);
			glTexCoord2f(1.0f + moveF, 0.0f); glVertex3fv(vertice[3]);
			glTexCoord2f(0.0f + moveF, 0.0f); glVertex3fv(vertice[2]);
		glEnd();

		glBegin(GL_POLYGON);  //Left
			glNormal3f(1.0f, 0.0f, 0.0f);
			glTexCoord2f(1.0f - moveI, 0.0f); glVertex3fv(vertice[1]);
			glTexCoord2f(1.0f - moveI, 1.0f); glVertex3fv(vertice[7]);
			glTexCoord2f(0.0f - moveF, 1.0f); glVertex3fv(vertice[6]);
			glTexCoord2f(0.0f - moveF, 0.0f); glVertex3fv(vertice[2]);
		glEnd();
...
void CFiguras::prisma3(GLuint text, GLuint text2,float repeticiones)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(repeticiones, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(repeticiones, repeticiones); glVertex3fv(vertice[7]);
	glTexCoord2f(0.0f, repeticiones); glVertex3fv(vertice[1]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(repeticiones, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(repeticiones, repeticiones); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, repeticiones); glVertex3fv(vertice[4]);
	glEnd();

	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(repeticiones, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(repeticiones, repeticiones); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, repeticiones); glVertex3fv(vertice[2]);
	glEnd();

	glBegin(GL_POLYGON);  //Left
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(repeticiones, 0.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(repeticiones, repeticiones); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, repeticiones); glVertex3fv(vertice[2]);
	glEnd();
	...
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(repeticiones, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(repeticiones, repeticiones); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, repeticiones); glVertex3fv(vertice[3]);
	glEnd();
	...
	glTexCoord2f(repeticiones, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(repeticiones, repeticiones); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, repeticiones); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[7]);
	glRotatef(-90, 0, 1, 0);
	glEnd();
}
...
void CFiguras::prisma4(GLuint text, GLuint text2, float repeticionesX, float repeticionesY)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(0.0, repeticionesY); glVertex3fv(vertice[7]);
	glTexCoord2f(repeticionesX, repeticionesY); glVertex3fv(vertice[4]);
	glTexCoord2f(repeticionesX, 0.0f); glVertex3fv(vertice[0]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(repeticionesX, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(repeticionesX, repeticionesY); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, repeticionesY); glVertex3fv(vertice[4]);
	glEnd();

	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(repeticionesX, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(repeticionesX, repeticionesY); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, repeticionesY); glVertex3fv(vertice[2]);
	glEnd();

	glBegin(GL_POLYGON);  //Left
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(repeticionesX, 0.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(repeticionesX, repeticionesY); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, repeticionesY); glVertex3fv(vertice[2]);
	glEnd();
	...
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(repeticionesX, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(repeticionesX, repeticionesY); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, repeticionesY); glVertex3fv(vertice[3]);
	glEnd();

	glBindTexture(GL_TEXTURE_2D, text);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 1.0f, 0.0f);
		glTexCoord2f(repeticionesX, 0.0f); glVertex3fv(vertice[4]);
		glTexCoord2f(repeticionesX, repeticionesY); glVertex3fv(vertice[5]);
		glTexCoord2f(0.0f, repeticionesY); glVertex3fv(vertice[6]);
		glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[7]);
	glEnd();
}
